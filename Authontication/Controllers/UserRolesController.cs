...
namespace Authontication.Controllers
{
    ...
    public class UserRolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,RoleId,hhh")] AspNetUserRole aspNetUserRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,RoleId,hhh")] AspNetUserRole aspNetUserRole)
        {
            if (ModelState.IsValid)
            {
